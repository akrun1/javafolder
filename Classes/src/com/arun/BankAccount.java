...
public class BankAccount {
    ...
    public BankAccount(String number, double accountBalance, String customerName, String customerEmail, String customerPhoneNumber) {
    ...
    public void deposit(double depositAmount) {
        ...
        System.out.println("Deposit amount of " + depositAmount + " made.  New balance is " + this.accountBalance);
    }
